...
with base as (
  select *
  from `spiritual-hour-458020-c6.pagila_prodpublic.film_actor` --Your table path
  )
...
get_ipython().system('python -m jupyter nbconvert stg_film_actor.ipynb --to python')
