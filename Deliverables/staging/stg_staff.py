...
with base as (
  select *
  from `spiritual-hour-458020-c6.pagila_prodpublic.staff` --Your table path
  )
...
schema = [
    ...
    bigquery.SchemaField('is_active_staff', 'BOOL'),
]
...
get_ipython().system('python -m jupyter nbconvert stg_staff.ipynb --to python')
