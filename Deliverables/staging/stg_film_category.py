...
with base as (
  select *
  from `spiritual-hour-458020-c6.pagila_prodpublic.film_category` --Your table path
  )
...
get_ipython().system('python -m jupyter nbconvert stg_film_category.ipynb --to python')
