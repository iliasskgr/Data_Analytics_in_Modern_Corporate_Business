...
with base as (
  select *
  from `spiritual-hour-458020-c6.pagila_prodpublic.customer` --Your table path
  )
...
schema = [
    ...
    bigquery.SchemaField('customer_last_update', 'TIMESTAMP'),
...
get_ipython().system('python -m jupyter nbconvert stg_customer.ipynb --to python')
